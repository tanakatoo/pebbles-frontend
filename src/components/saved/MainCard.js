    ...
    return (
        <Link to={link}>
            <div className={`drop-shadow-md shrink-0 relative w-[200px] h-[200px] rounded-ml ${img} bg-cover flex flex-col items-center justify-center`}>
                ...
                <span className={`drop-shadow-xl text-center z-10 text-primary-dark text-mobile-page-header font-medium bg-white/75 px-2 rounded-sm w-full py-2`} >{text}</span>
