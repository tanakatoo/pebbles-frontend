...
function HowToSite() {
    ...
    return (
        <div className='py-8 flex flex-col ' id="top">
            ...
            <div className='w-full flex flex-col pt-4 md:pt-8 pb-12 px-2 bg-primary-super-light '>
                <div className=' mx-auto flex flex-col '>
                    ...
                    <div className='my-1 ' >
                        <div className='group'>
                            <HashLink to="#profile" className=' group-hover:underline group-hover:underline-offset-4 group-hover:text-gray-text'>
                                {pageText.PROFILE}
                    ...
                    <div className='my-1 '>
                        <div className='group'>
                            <HashLink to="#study-buddy-usage" className=' group-hover:underline group-hover:underline-offset-4 group-hover:text-gray-text'>
            ...
            <div className='container flex flex-col mx-auto mt-8'>
                <div className='max-w-prose mx-auto'>
                    <h2 id="profile" className='me-auto text-mobile-section-header font-medium my-4'>
                        {pageText.PROFILE}</h2>
                ...
                <div className='max-w-prose mx-auto'>
                    <h2 id="study-buddy" className='pt-4 max-w-prose me-auto text-mobile-section-header font-medium my-4'>
                ...
                <div className='max-w-prose mx-auto'>
                    <h2 id="study-buddy-usage" className='pt-4 max-w-prose me-auto text-mobile-section-header font-medium my-4'>
